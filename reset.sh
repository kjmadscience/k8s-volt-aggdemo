...
sleep 90
kubectl cp schema/voltdb-aggdemo-createDB.sql mydb-voltdb-cluster-0:/tmp/ -n volt

kubectl cp schema/procs.jar mydb-voltdb-cluster-0:/tmp/ -n volt

kubectl exec -it mydb-voltdb-cluster-0 -n volt -- sqlcmd < schema/voltdb-aggdemo-createDB.sql
